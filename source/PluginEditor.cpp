    ...
    : AudioProcessorEditor(&p), audioProcessor(p), scope(p), spectrum(p), lfoShape(p), matrixView(p)
{
    ...
    subtitle.setText("flagship bass instrument · smoother harmonics · refined source routing · sub and noise precision · hero wavetable theatre", dontSendNotification);
...
void FiveParksVST3AudioProcessorEditor::resized()
{
    ...
    area.removeFromTop(10);
    auto row1 = area.removeFromTop(230);
